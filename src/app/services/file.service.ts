...
// import { DocumentManagementService as HttpService } from '../../shared/axios';
...
//   return response;
// };
// const restoreFileByIdFromDB = async (
//   req: Request,
// ): Promise<IGenericResponse> => {
//   const { fileId } = req.params;
//   const response: IGenericResponse = await HttpService.patch(
...
//   return response;
// };
// const deleteFilePermanentlyByIdFromDB = async (
//   req: Request,
// ): Promise<IGenericResponse> => {
//   const { fileId } = req.params;
...
//   restoreFileByIdFromDB,
//   deleteFilePermanentlyByIdFromDB,
// };
